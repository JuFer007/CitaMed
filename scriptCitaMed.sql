...
('JUAN CARLOS',      'QUISPE',      'MAMANI',     '71234501', '951234501', 'Av. Agricultura 101, Chiclayo',      'jc.quispe@gmail.com',              '1990-02-14', 'MASCULINO', 'O_POSITIVO', TRUE, 19),
('MARIA ELENA',      'SOTO',        'VARGAS',     '71234502', '951234502', 'Jr. Los Alamos 202, Chiclayo',       'maria.soto@gmail.com',             '1985-06-23', 'FEMENINO',  'A_POSITIVO', TRUE, 21),
('PEDRO PABLO',      'HUAMAN',      'QUISPE',     '71234503', '951234503', 'Calle Los Fresnos 303, Chiclayo',    'pedro.huaman@gmail.com',           '1978-11-05', 'MASCULINO', 'B_POSITIVO', TRUE, 22),
('LUCIA ROSA',       'PAREDES',     'TORRES',     '71234504', '951234504', 'Av. Fitzcarrald 404, Chiclayo',      'lucia.paredes@gmail.com',          '1995-03-18', 'FEMENINO',  'AB_POSITIVO', TRUE, 23),
('CARLOS ALBERTO',   'MENDOZA',     'LOPEZ',      '71234505', '951234505', 'Jr. San Martin 505, Chiclayo',       'carlos.mendoza.p@gmail.com',       '1988-07-30', 'MASCULINO', 'O_NEGATIVO', TRUE, 24),
('ANA SOFIA',        'ROJAS',       'CASTRO',     '71234506', '951234506', 'Calle Dos de Mayo 606, Chiclayo',    'ana.rojas@gmail.com',              '1992-09-12', 'FEMENINO',  'A_NEGATIVO', TRUE, 25),
('ROBERTO JESUS',    'VARGAS',      'DIAZ',       '71234507', '951234507', 'Av. Saenz Pena 707, Chiclayo',       'roberto.vargas@gmail.com',         '1975-01-08', 'MASCULINO', 'B_NEGATIVO', TRUE, 26),
('ISABEL CRISTINA',  'CHAVEZ',      'MORALES',    '71234508', '951234508', 'Jr. Ladislao Espinar 808, Chiclayo', 'isabel.chavez@gmail.com',          '1983-05-27', 'FEMENINO',  'O_POSITIVO', TRUE, 27),
('DIEGO ALEJANDRO',  'FUENTES',     'HERRERA',    '71234509', '951234509', 'Calle Pedro Ruiz 909, Chiclayo',     'diego.fuentes@gmail.com',          '1998-12-03', 'MASCULINO', 'A_POSITIVO', TRUE, 28),
('VALENTINA',        'ESPINOZA',    'NUNEZ',      '71234510', '951234510', 'Av. Leguia 1010, Chiclayo',          'valentina.espinoza@gmail.com',     '2001-04-16', 'FEMENINO',  'AB_NEGATIVO', TRUE, 29),
('ANDRES FELIPE',    'LLONTOP',     'BANCES',     '71234511', '951234511', 'Jr. Colon 111, Chiclayo',            'andres.llontop@gmail.com',         '1970-08-21', 'MASCULINO', 'O_POSITIVO', TRUE, 30),
('GABRIELA NOEMI',   'ZULOETA',     'CARRASCO',   '71234512', '951234512', 'Av. Pedro Ruiz 222, Chiclayo',       'gabriela.zuloeta@gmail.com',       '1987-10-09', 'FEMENINO',  'B_POSITIVO', TRUE, 31),
('RICARDO MANUEL',   'GONZALES',    'MURO',       '71234513', '951234513', 'Calle Izaga 333, Chiclayo',          'ricardo.gonzales@gmail.com',       '1993-02-28', 'MASCULINO', 'A_POSITIVO', TRUE, 32),
('SOFIA VALENTINA',  'CHAFLOQUE',   'SOLIS',      '71234514', '951234514', 'Jr. 8 de Octubre 444, Chiclayo',     'sofia.chafloque@gmail.com',        '2000-06-14', 'FEMENINO',  'O_POSITIVO', TRUE, 33),
('MARTIN EDUARDO',   'IDROGO',      'BUSTAMANTE', '71234515', '951234515', 'Av. Los Incas 555, Chiclayo',        'martin.idrogo@gmail.com',          '1965-11-30', 'MASCULINO', 'A_NEGATIVO', TRUE, 34),
('PATRICIA LUZ',     'CORONADO',    'DIAZ',       '71234516', '951234516', 'Calle Real 666, Chiclayo',           'patricia.coronado@gmail.com',      '1980-03-07', 'FEMENINO',  'B_POSITIVO', TRUE, 35),
('EDUARDO JESUS',    'SAAVEDRA',    'NEYRA',      '71234517', '951234517', 'Jr. San Jose 777, Chiclayo',         'eduardo.saavedra@gmail.com',       '1972-07-19', 'MASCULINO', 'O_POSITIVO', TRUE, 36),
('CLAUDIA BEATRIZ',  'SEGURA',      'MONTOYA',    '71234518', '951234518', 'Av. Chiclayo 888, Chiclayo',         'claudia.segura@gmail.com',         '1996-09-02', 'FEMENINO',  'AB_POSITIVO', TRUE, 37),
('MARCO ANTONIO',    'BECERRA',     'VILLANUEVA', '71234519', '951234519', 'Calle Los Pinos 999, Chiclayo',      'marco.becerra@gmail.com',          '1982-01-25', 'MASCULINO', 'A_POSITIVO', TRUE, 38),
('NATALIA ANDREA',   'CUBAS',       'MEJIA',      '71234520', '951234520', 'Jr. Victor Raul 1100, Chiclayo',     'natalia.cubas@gmail.com',          '1991-05-11', 'FEMENINO',  'O_NEGATIVO', TRUE, 39),
('CESAR AUGUSTO',    'FERNANDEZ',   'PAZ',        '71234521', '951234521', 'Av. Chinchaysuyo 200, Chiclayo',     'cesar.fernandez@gmail.com',        '1969-03-15', 'MASCULINO', 'B_POSITIVO', TRUE, 40),
('MILAGROS',         'PUELLES',     'ASALDE',     '71234522', '951234522', 'Jr. Los Jazmines 300, Chiclayo',     'milagros.puelles@gmail.com',       '1976-08-29', 'FEMENINO',  'O_POSITIVO', TRUE, 41),
('JHON ALEXANDER',   'GUERRERO',    'RIVADENEYRA','71234523', '951234523', 'Calle Manco Capac 400, Chiclayo',    'jhon.guerrero@gmail.com',          '1999-12-17', 'MASCULINO', 'A_POSITIVO', TRUE, 42),
('FIORELLA MILAGROS','TELLO',       'PERALES',    '71234524', '951234524', 'Av. Venezuela 500, Chiclayo',        'fiorella.tello@gmail.com',         '2003-04-05', 'FEMENINO',  'AB_POSITIVO', TRUE, 43),
('ALEJANDRO LUIS',   'SANTISTEBAN', 'CABREJOS',   '71234525', '951234525', 'Jr. Elias Aguirre 600, Chiclayo',    'alejandro.santisteban@gmail.com',  '1960-06-20', 'MASCULINO', 'O_POSITIVO', TRUE, 44);
...
((SELECT id FROM pacientes WHERE dni = '71234501'), 8,    11,      '2026-05-06 09:00:00', 'Dolor de cabeza persistente y mareos',      'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234502'), 4,  4,     '2026-05-05 08:00:00', 'Revision de presion arterial alta',         'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234503'), 5,  6,  '2026-05-04 08:00:00', 'Control pediatrico de nino de 5 anos',       'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234504'), 6, 8,     '2026-05-05 15:00:00', 'Consulta por irregularidades menstruales',   'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234505'), 7,    10,   '2026-05-04 09:00:00', 'Dolor en rodilla derecha tras caida',        'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234506'), 8,    11,      '2026-05-13 09:00:00', 'Episodios de migrana frecuentes',            'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234507'), 3, 1,   '2026-05-04 14:00:00', 'Tos persistente y fiebre leve',              'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234508'), 4,  4,     '2026-05-07 08:00:00', 'Palpitaciones y cansancio',                  'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234501'), 3, 1,   '2026-05-06 14:00:00', 'Control medico trimestral',                  'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234509'), 9,   16,      '2026-05-08 09:00:00', 'Dermatitis en brazos',                       'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234505'), 7,    10,   '2026-05-11 09:00:00', 'Revision de fractura curada',                'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234515'), 11, 17,  '2026-05-05 08:00:00', 'Hipotiroidismo, control mensual',            'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234510'), 11, 17,  '2026-05-07 08:00:00', 'Fatiga extrema y aumento de peso',           'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234511'), 12,   18,     '2026-05-04 15:00:00', 'Nauseas y dolor abdominal',                  'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234512'), 3, 1,   '2026-05-08 14:00:00', 'Chequeo medico general',                     'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234513'), 5,  6,  '2026-05-06 08:00:00', 'Fiebre alta en nino de 8 anos',              'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234514'), 6, 8,     '2026-05-07 15:00:00', 'Control de embarazo mes 5',                  'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234515'), 7,    10,   '2026-05-18 09:00:00', 'Dolor lumbar cronico',                       'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234522'), 12,   18,     '2026-05-06 15:00:00', 'Gastroenterologia, seguimiento',             'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234508'), 4,  4,     '2026-05-09 09:00:00', 'Hipertension, ajuste de tratamiento',        'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234516'), 3, 1,   '2026-05-11 14:00:00', 'Resfriado y dolor de garganta',              'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234517'), 8,    11,      '2026-05-20 09:00:00', 'Entumecimiento en extremidades',             'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234518'), 4,  4,     '2026-05-12 08:00:00', 'Control post-operatorio cardiaco',           'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234519'), 12,   18,     '2026-05-11 15:00:00', 'Gastritis y acidez estomacal',               'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234520'), 6, 8,     '2026-05-08 15:00:00', 'Revision de quiste ovarico',                 'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234521'), 5,  6,  '2026-05-11 08:00:00', 'Vacunacion y control de crecimiento',        'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234522'), 12,   18,     '2026-05-13 15:00:00', 'Colon irritable, control mensual',           'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234523'), 7,    10,   '2026-05-25 09:00:00', 'Esguince de tobillo izquierdo',              'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234524'), 9,   16,      '2026-05-15 09:00:00', 'Acne y problemas en piel grasa',             'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234525'), 11, 17,  '2026-05-12 08:00:00', 'Diabetes tipo 2, control trimestral',        'ATENDIDA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234510'), 7,    10,   '2026-06-01 09:00:00', 'Dolor de espalda y fatiga',                  'PROGRAMADA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234506'), 8,    11,      '2026-05-27 09:00:00', 'Vertigo y perdida de equilibrio',            'PROGRAMADA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234501'), 4,  4,     '2026-06-02 08:00:00', 'Presion alta y dolor de cabeza',             'PROGRAMADA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234503'), 5,  6,  '2026-06-01 08:00:00', 'Control de asma infantil',                   'PROGRAMADA');

INSERT INTO citas (paciente_id, medico_id, consultorio_id, fecha_hora, motivo_consulta, estado) VALUES
((SELECT id FROM pacientes WHERE dni = '71234502'), 4,  4,     '2026-05-28 08:00:00', 'Arritmia, control semestral',                'PROGRAMADA');

-- ============================================================
-- 10. PAGOS
-- ============================================================
INSERT INTO pagos (cita_id, monto, metodo_pago, estado, fecha_pago) VALUES
(1,  140.00, 'EFECTIVO',      'PAGADO', '2026-05-06 09:05:00'),
(2,  150.00, 'TARJETA',       'PAGADO', '2026-05-05 08:05:00'),
(3,  90.00,  'EFECTIVO',      'PAGADO', '2026-05-04 08:05:00'),
(4,  130.00, 'TRANSFERENCIA', 'PAGADO', '2026-05-05 15:05:00'),
(5,  120.00, 'EFECTIVO',      'PAGADO', '2026-05-04 09:05:00'),
(6,  140.00, 'TARJETA',       'PAGADO', '2026-05-13 09:05:00'),
(7,  80.00,  'EFECTIVO',      'PAGADO', '2026-05-04 14:05:00'),
(8,  150.00, 'EFECTIVO',      'PAGADO', '2026-05-07 08:05:00'),
(9,  80.00,  'TARJETA',       'PAGADO', '2026-05-06 14:05:00'),
(10, 100.00, 'TRANSFERENCIA', 'PAGADO', '2026-05-08 09:05:00'),
(11, 120.00, 'EFECTIVO',      'PAGADO', '2026-05-11 09:05:00'),
(12, 115.00, 'EFECTIVO',      'PAGADO', '2026-05-05 08:05:00'),
(13, 115.00, 'TARJETA',       'PAGADO', '2026-05-07 08:05:00'),
(14, 125.00, 'EFECTIVO',      'PAGADO', '2026-05-04 15:05:00'),
(15, 80.00,  'TRANSFERENCIA', 'PAGADO', '2026-05-08 14:05:00'),
(16, 90.00,  'EFECTIVO',      'PAGADO', '2026-05-06 08:05:00'),
(17, 130.00, 'TARJETA',       'PAGADO', '2026-05-07 15:05:00'),
(18, 120.00, 'TARJETA',       'PAGADO', '2026-05-18 09:05:00'),
(19, 125.00, 'EFECTIVO',      'PAGADO', '2026-05-06 15:05:00'),
(20, 150.00, 'EFECTIVO',      'PAGADO', '2026-05-09 09:05:00'),
(21, 80.00,  'EFECTIVO',      'PAGADO', '2026-05-11 14:05:00'),
(22, 140.00, 'TARJETA',       'PAGADO', '2026-05-20 09:05:00'),
(23, 150.00, 'EFECTIVO',      'PAGADO', '2026-05-12 08:05:00'),
(24, 125.00, 'TARJETA',       'PAGADO', '2026-05-11 15:05:00'),
(25, 130.00, 'TRANSFERENCIA', 'PAGADO', '2026-05-08 15:05:00'),
(26, 90.00,  'EFECTIVO',      'PAGADO', '2026-05-11 08:05:00'),
(27, 125.00, 'TARJETA',       'PAGADO', '2026-05-13 15:05:00'),
(28, 120.00, 'EFECTIVO',      'PAGADO', '2026-05-25 09:05:00'),
(29, 100.00, 'EFECTIVO',      'PAGADO', '2026-05-15 09:05:00'),
(30, 115.00, 'TARJETA',       'PAGADO', '2026-05-12 08:05:00'),
-- Citas PROGRAMADAS (31-35): pago pendiente, aun no se realiza el cobro
(31, 120.00, NULL, 'PENDIENTE', NULL),
(32, 140.00, NULL, 'PENDIENTE', NULL),
(33, 150.00, NULL, 'PENDIENTE', NULL),
(34, 90.00,  NULL, 'PENDIENTE', NULL),
(35, 150.00, NULL, 'PENDIENTE', NULL);
...
('CONTROL MEDICO SIN HALLAZGOS',       'Chequeo trimestral de rutina, examen fisico sin alteraciones',                 'Multivitaminico 1 tableta/dia',                                                                          'Continuar habitos saludables. Proximo control en 3 meses.',                              9),
('DERMATITIS ATOPICA',                 'Dermatitis atopica leve en pliegues de codos y rodillas',                      'Betametasona crema 0.05% topico / Emoliente corporal',                                                   'Aplicar capa fina en zona afectada. Emoliente tras el bano. No en cara.',                10),
('FRACTURA CONSOLIDADA',               'Fractura de radio distal en proceso de consolidacion completa, retiro de inmovilizacion', 'Calcio + Vitamina D 600mg/1000UI',                                                       'Iniciar fisioterapia de rehabilitacion. Evitar cargas pesadas por 2 semanas mas.',       11),
('HIPOTIROIDISMO PRIMARIO',            'Hipotiroidismo diagnosticado por TSH elevada y T4 libre bajo',                 'Levotiroxina 50mcg en ayunas',                                                                           'Esperar 30 min antes de comer. No con calcio o hierro. Control TSH en 4 sem.',           12),
('HIPOTIROIDISMO SUBCLINICO',          'TSH levemente elevada compatible con hipotiroidismo subclinico',               'Levotiroxina 25mcg en ayunas',                                                                           'Control de TSH en 6 semanas. Esperar 30 min antes de comer.',                            13),
('GASTRITIS CRONICA',                  'Gastritis antral cronica no erosiva, H. pylori negativo',                      'Omeprazol 20mg antes del desayuno / Sucralfato 1g 3 veces al dia',                                       'Dieta blanda sin irritantes. Evitar AINES. Sucralfato 1h antes de comidas.',             14),
('SIN PATOLOGIA AGUDA',                'Examen fisico y laboratorios dentro de rangos normales',                       '',                                                                                                        'Continuar habitos saludables. Actividad fisica 150 min/semana. Control anual.',          15),
('AMIGDALITIS BACTERIANA',             'Amigdalitis pultacea compatible con Streptococcus pyogenes',                   'Amoxicilina 500mg cada 8h / Ibuprofeno pediatrico 200mg',                                                'Completar tratamiento 7 dias. Gargaras salinas. Calcular ibuprofeno por peso.',          16),
('EMBARAZO NORMAL SEMANA 22',          'Gestacion de bajo riesgo con feto en adecuadas condiciones',                   'Acido folico 1mg/dia / Sulfato ferroso 300mg',                                                           'Indispensable en embarazo. Tomar con vitamina C para absorcion de hierro.',              17),
('LUMBALGIA MECANICA',                 'Lumbalgia inespecifica de tipo mecanico sin irradiacion',                      'Ciclobenzaprina 5mg cada 8h / Diclofenaco 75mg cada 12h',                                                'Fisioterapia 3 veces/semana. Faja lumbar en actividad. Puede causar somnolencia.',       18),
('COLITIS CRONICA EN CONTROL',         'Evolucion favorable de colitis, sin signos de actividad inflamatoria',         'Mesalazina 500mg cada 12h',                                                                              'Mantener dieta baja en residuos. Proximo control en 2 meses.',                            19),
('HIPERTENSION ARTERIAL NO CONTROLADA','Cifras tensionales por encima de meta pese a tratamiento actual, se ajusta dosis','Losartan 50mg cada 12h / Amlodipino 5mg/dia',                                                            'Monitoreo de presion arterial diario. Dieta hiposodica estricta.',                        20),
('FARINGOAMIGDALITIS VIRAL',           'Infeccion viral de vias respiratorias altas sin complicaciones',              'Paracetamol 1g cada 8h',                                                                                 'Reposo relativo 48h. No sobrepasar 3g al dia. Hidratacion abundante.',                   21),
('NEUROPATIA PERIFERICA LEVE',         'Parestesias en manos sin deficit motor, origen a determinar',                 'Vitamina B1 100mg/dia / Vitamina B12 500mcg/dia',                                                        'Ejercicios de movilidad de manos. Tomar con el desayuno.',                               22),
('POST-OPERATORIO BYPASS',             'Buena evolucion post bypass aortocoronario de doble vaso',                    'Aspirina 100mg/dia / Clopidogrel 75mg/dia / Warfarina 5mg/dia',                                          'Antiagregante + anticoagulante. Control INR semanal. Consultar antes de procedimientos.',23),
('GASTRITIS POR AINES',                'Irritacion gastrica secundaria al uso cronico de ibuprofeno',                 'Omeprazol 20mg antes del desayuno',                                                                      'Suspender AINES. Dieta blanda. Evitar alcohol.',                                         24),
('QUISTE OVARICO FUNCIONAL',           'Quiste folicular en ovario derecho de 3cm, sin tabiques',                     'Anticonceptivo oral 1 comprimido cada 24h',                                                              'Tomar a la misma hora. Ecografia de control en 60 dias.',                                25),
('DESARROLLO NORMAL',                  'Crecimiento y desarrollo acordes a percentiles para la edad',                 'Sulfato ferroso 300mg/dia / Vitamina D 400UI/dia',                                                       'Vacuna triple viral aplicada. Suplemento para crecimiento.',                             26),
('SINDROME DE INTESTINO IRRITABLE',    'SII con predominio diarreico, criterios de Roma IV',                          'Loperamida 2mg segun necesidad / Probiotico Lactobacillus 1 capsula/dia',                                 'Dieta baja en FODMAP. Evitar lactosa y gluten. Refrigerar probiotico.',                   27),
('ESGUINCE DE TOBILLO GRADO II',       'Lesion ligamentosa parcial en tobillo izquierdo',                             'Ibuprofeno 400mg cada 8h / Diclofenaco gel 1% topico',                                                   'Inmovilizacion 10 dias. Hielo local. Aplicar gel con masaje suave.',                     28),
('ACNE VULGAR GRADO 2',                'Acne inflamatorio moderado en region facial y dorsal',                        'Tretinona crema 0.025% nocturna / Doxiciclina 100mg cada 12h',                                           'Protector solar diario. Doxiciclina con abundante agua. No acostarse inmediatamente.',   29),
('DIABETES MELLITUS TIPO 2',           'DM2 descompensada con HbA1c de 9.2%',                                        'Metformina 850mg cada 12h / Insulina Glargina 10 UI nocturna',                                           'Control glucemico diario. Dieta diabetica estricta. Rotar zonas de insulina.',           30);
